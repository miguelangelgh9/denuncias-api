...
class RegistrationView(BaseRegistrationView):
    ...
    def send_activation_email(self, user):
        ...
        TEXT = "Utilice el siguiente codigo para verificar su cuenta: "+ "'" + activation_key + "'" + "\n\nRecuerde que solamente cuenta con 2 dias para activarla, de otra forma tendra que contactar a un administrador para activar su cuenta"
